 ...
 * @author thusitha
 */
public class CanvasFlipFacing extends javax.swing.JFrame implements BookDisplay{
    
    public JBookPanel filpbook;
    private int pageL=0;
     ...
     */
    public CanvasFlipFacing(BookReader bookReader) {
        initComponents();
        ...
        innerPanel.setSize((2*innerWidth)+slidGap, innerHeight);
        innerPanel.setPreferredSize(new Dimension((2*innerWidth)+slidGap, innerHeight));
        innerPanel.setLayout(new GridLayout(1, 1, slidGap, slidGap));
        
        filpbook = new JBookPanel(bookReader.pages,bookReader,this, bookReader.webPanel8.getWidth()/2-100, bookReader.webPanel8.getHeight()-50);
        filpbook.setBackground(Color.darkGray);
        filpbook.setSize(bookReader.webPanel8.getWidth()/2-100, bookReader.webPanel8.getHeight()-50);
        filpbook.setPreferredSize(new Dimension(bookReader.webPanel8.getWidth()/2-100, bookReader.webPanel8.getHeight()-50));
        filpbook.setOpaque(true);
        innerPanel.add(filpbook);
        filpbook.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanvasFlipFacing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanvasFlipFacing(null).setVisible(true);
            }
        });
    }
    ...
    public void Zoom(double ratio) {
        ...
        innerPanel.setPreferredSize(new Dimension((int) (2*innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)) ));
        outerPanel.setPreferredSize(new Dimension((int) (webPanel1.getWidth()*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)) ));
        ...
        filpbook = new JBookPanel(bookReader.pages,bookReader,this, bookReader.webPanel8.getWidth()/2-100, bookReader.webPanel8.getHeight()-50);
        filpbook.setBackground(Color.darkGray);
        filpbook.setSize(innerWidth, innerHeight);
        filpbook.setOpaque(true);
        innerPanel.add(filpbook);
        filpbook.setVisible(true);
    ...
    public void jumpPage(int pageIndex) {
        if (pageIndex%2==0) {
            ...
            filpbook.setLeftPageIndex(pageIndex);
        }else{
            pageL=pageIndex-1;
            if (bookReader.SEPERATE) {
                pageL++;
    ...
    public void paintPage(int pageIndex, Image img) {
        ...
        if (pageIndex==pageL) {//current left
            try {
                filpbook.setCurrentLeft(img.getScaledInstance((int) (innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)), Image.SCALE_SMOOTH));
            } catch (Exception e) {
            }
        }else if (pageIndex==pageL+1) {//current right
            try {
                filpbook.setCurrentRight(img.getScaledInstance((int) (innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)), Image.SCALE_SMOOTH));
            } catch (Exception e) {
            }
        }else if (pageIndex==pageL-2) {//previous left
            try {
                filpbook.previousLeftImage=img;
            } catch (Exception e) {
            }
        }else if (pageIndex==pageL-1) {//previous right
            try {
                filpbook.previousRightImage=img;
            } catch (Exception e) {
            }
        }else if (pageIndex==pageL+2) {//next left
            try {
                filpbook.nextLeftImage=img;
            } catch (Exception e) {
            }
        }else if (pageIndex==pageL+3) {//next right
            try {
                filpbook.nextRightImage=img;
            } catch (Exception e) {
            }
        }
        filpbook.repaint();
    ...
    public void cleanPage(int pageIndex) {
        if (pageIndex==pageL) {
            try {
                filpbook.setCurrentLeft(null);
            } catch (Exception e) {
            }
        }
        if (pageIndex==pageL+1) {
            try {
                filpbook.setCurrentRight(null);
            } catch (Exception e) {
            }
        }
        filpbook.repaint();
