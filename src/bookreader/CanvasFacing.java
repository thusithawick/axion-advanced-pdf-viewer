 ...
 * @author thusitha
 */
public class CanvasFacing extends javax.swing.JFrame implements BookDisplay{
     ...
     */
    public CanvasFacing(BookReader bookReader) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanvasFacing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanvasFacing(null).setVisible(true);
            }
        });
    }
    ...
    public void paintPage(int pageIndex, Image img) {
        if (pageIndex==pageL) {
            try {
                page1.setIcon(new ImageIcon(img.getScaledInstance((int) (innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)), Image.SCALE_SMOOTH)));
            } catch (Exception e) {
            }
        }
        if (pageIndex==pageL+1) {
            try {
                page2.setIcon(new ImageIcon(img.getScaledInstance((int) (innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)), Image.SCALE_SMOOTH)));
            } catch (Exception e) {
            }
        }
    }
