 ...
 * @author thusitha
 */
public class CanvasSketchFacing extends javax.swing.JFrame implements BookDisplay{
    ...
    private final int slidGap=0;
    /**
     * Creates new form CanvasContinues
     */
    public CanvasSketchFacing(BookReader bookReader) {
        initComponents();
        ...
        innerPanel.setLayout(new GridLayout(1, 2, slidGap, slidGap));
        
        page1 = new JLabel();
        page1.setBackground(Color.white);
        page1.setSize(innerWidth, innerHeight);
        page1.setOpaque(true);
        innerPanel.add(page1);
        page1.setVisible(true);
        
        page2 = new JLabel();
        page2.setBackground(Color.white);
        page2.setSize(innerWidth, innerHeight);
        page2.setOpaque(true);
        innerPanel.add(page2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanvasSketchFacing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanvasSketchFacing(null).setVisible(true);
            }
        });
    }
    ...
    public void paintPage(int pageIndex, Image img) {
        if (pageIndex==pageL) {
            try {
                page1.setIcon(new ImageIcon(img.getScaledInstance(page1.getWidth(),page1.getHeight(), Image.SCALE_SMOOTH)));
            } catch (Exception e) {
            }
        }
        if (pageIndex==pageL+1) {
            try {
                page2.setIcon(new ImageIcon(img.getScaledInstance(page1.getWidth(),page1.getHeight(), Image.SCALE_SMOOTH)));
            } catch (Exception e) {
            }
        }
    }
