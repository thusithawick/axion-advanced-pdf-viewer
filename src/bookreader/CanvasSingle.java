 ...
 * @author thusitha
 */
public class CanvasSingle extends javax.swing.JFrame implements BookDisplay{
     ...
     */
    public CanvasSingle(BookReader bookReader) {
        initComponents();
        ...
        page.setSize(innerWidth, innerHeight);
        page.setOpaque(true);
        innerPanel.add(page);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanvasSingle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanvasSingle(null).setVisible(true);
            }
        });
    }
    ...
    public void Zoom(double ratio) {
        ...
        innerPanel.setPreferredSize(new Dimension((int) (innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)) ));
    ...
    public void paintPage(int pageIndex, Image img) {
        if(pageIndex==BookReader.currentPage){
            try {
            page.setIcon(new ImageIcon(img.getScaledInstance((int) (innerWidth*(1+zoomRatio)),(int)  (innerHeight*(1+zoomRatio)), Image.SCALE_SMOOTH)));
            } catch (Exception e) {
            }
        }
    }
