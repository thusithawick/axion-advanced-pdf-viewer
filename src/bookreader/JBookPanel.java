...
public class JBookPanel extends JPanel implements MouseInputListener, ActionListener {
	 ...
	 * Constructor
	 */
	public JBookPanel(int pages, BookReader bookReader, CanvasFlipFacing filpface, int width, int height) {
		super();
                this.bookReader=bookReader;
                this.flipface=filpface;
			...
			if (passedThreshold()) {
				...
				if (leftPageTurn) {
                                    ...
                                    if (bookReader.SEPERATE) {
                                        leftPageIndex=bookReader.currentPage+2;
                                        bookReader.currentPage-=1;
                                        flipface.setPageL(bookReader.currentPage);
                                        bookReader.webTextField1.setText(String.valueOf(bookReader.currentPage));
                                    }else{
                                        leftPageIndex=bookReader.currentPage+2;
                                        bookReader.currentPage-=2;
                                        flipface.setPageL(bookReader.currentPage);
                                        bookReader.webTextField1.setText(String.valueOf(bookReader.currentPage));
                                    }
	...
	public void setLeftPageIndex(int leftPageIndex) {
        ...
        public void setCurrentLeft(Image img){
            currentLeftImage = img;
        }
        public void setCurrentRight(Image img){
            currentRightImage = img;
        }
}